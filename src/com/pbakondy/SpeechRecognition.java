...
public class SpeechRecognition extends CordovaPlugin {
    ...
    if (requestCode == REQUEST_CODE_SPEECH) {
      if (resultCode == Activity.RESULT_OK) {
        try {
          ...
          File appPath = new File(Environment.getExternalStorageDirectory(), "pictokk");
          if(!appPath.exists()) {
            appPath.mkdirs();
          }
          String fDate = new SimpleDateFormat("yyyyMMdd_hhmmss").format(new java.util.Date());
          String fname = "VOICE_" + fDate + ".amr";
          copyInputStreamToFile(filestream, new File(appPath + "/" + fname));
          JSONArray jsonMatches = new JSONArray(matches);
          jsonMatches.put(fname);

          Log.d(LOG_TAG, "JSONArray => jsonMatches : " + jsonMatches);
  ...
  private class SpeechRecognitionListener implements RecognitionListener {
    ...
    public void onBeginningOfSpeech() {
      Log.d(LOG_TAG, "SpeechRecognitionListener => onBeginningOfSpeech ");
    }

    @Override
    public void onBufferReceived(byte[] buffer) {
      Log.d(LOG_TAG, "SpeechRecognitionListener => onBufferReceived ");
    }

    @Override
    public void onEndOfSpeech() {
      Log.d(LOG_TAG, "SpeechRecognitionListener => onEndOfSpeech ");
    }
